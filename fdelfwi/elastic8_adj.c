...
#pragma simd
	...
	/*                                                               */
	/*  Phase F1 vx at iz=surface reads txz[surface] and below     */
	/*  through D+z, but Phase A2 txz starts at ioTz=surface+1     */
	/*  and misses these transpose contributions. Without them,     */
	/*  BV_adj's txz scatter has nothing to propagate and the       */
	/*  antisymmetric mirror coupling is lost.                      */
	/* ============================================================ */
	if (bnd.top == 1) {
