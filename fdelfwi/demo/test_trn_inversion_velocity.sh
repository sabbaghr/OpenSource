#!/bin/bash
#
# test_trn_inversion_velocity.sh - Truncated Newton inversion test (velocity param).
#
# Same model/geometry as test_lbfgs_inversion_velocity.sh:
#   - Constant background + 3 anomalies (Vp, Vs, rho)
#   - 5 shots, elastic, velocity parameterization
#   - Brossier scaling (scaling=1)
#
# Runs fwi_inversion with algorithm=4 (TRN), verbose=2 for diagnostics.
# TRN uses inner CG to approximate Newton direction, requiring Hessian-vector
# products (Born + adjoint per CG iteration). More expensive per iteration
# than L-BFGS but converges in fewer outer iterations.
#
...
# Working directory
WORKDIR=trn_inversion_velocity
mkdir -p ${WORKDIR}
cd ${WORKDIR}
...
echo "========================================================="
echo " TRN INVERSION TEST (Velocity param=2, scaling=1)"
echo "========================================================="
...
# =========================================================
# STEP 4: Run TRN inversion
# =========================================================
echo ""
echo "========================================================="
echo " Running TRN inversion"
echo "   algorithm=4 (TRN), niter=5, niter_cg=5, param=2 (velocity)"
...
${FDELFWI}/fwi_inversion \
    ...
    algorithm=4 niter_cg=5 \
    niter=5 nls_max=10 conv=1e-6 \
    write_iter=1 \
    verbose=2
...
echo " Model files:  model_iter???_vp.su, model_iter???_vs.su, model_iter???_rho.su"
echo " Gradient:     gradient_vp.su, gradient_vs.su, gradient_rho.su"
echo " Convergence:  iterate_TRN.dat, iterate_TRN_CG.dat"
echo "========================================================="
