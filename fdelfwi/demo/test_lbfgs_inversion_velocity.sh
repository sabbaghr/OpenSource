#!/bin/bash
#
# test_lbfgs_inversion_velocity.sh - L-BFGS inversion test (velocity param).
#
# Same model/geometry as test_gradient_visual_velocity.sh:
...
# Working directory
WORKDIR=lbfgs_inversion_velocity
mkdir -p ${WORKDIR}
cd ${WORKDIR}
...
echo "========================================================="
echo " L-BFGS INVERSION TEST (Velocity param=2, scaling=1)"
echo "========================================================="
...
echo "   algorithm=1 (L-BFGS), niter=5, param=2 (velocity)"
