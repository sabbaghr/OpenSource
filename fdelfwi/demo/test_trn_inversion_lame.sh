#!/bin/bash
#
# test_trn_inversion_lame.sh - Truncated Newton inversion test (Lame param).
#
# Same model/geometry as test_lbfgs_inversion_lame.sh:
...
echo "========================================================="
echo " TRN INVERSION TEST (Lame param=1, scaling=1)"
echo "========================================================="
...
echo "   algorithm=4 (TRN), niter=5, niter_cg=5, param=1 (Lame)"
